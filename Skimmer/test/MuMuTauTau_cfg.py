...
options.register('reportEvery', 5, VarParsing.multiplicity.singleton, VarParsing.varType.int, "Report every")
...
# Add the skim part
from HtoAA_Skimmer.Skimmer.customizeSkims import addMuMuTauTau
