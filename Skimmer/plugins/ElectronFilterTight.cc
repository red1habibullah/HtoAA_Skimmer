  ...
  trk_(consumes<reco::GsfTrackCollection>(iConfig.getParameter<edm::InputTag>("Tracks")))
{
  ...
  produces<reco::GsfElectronRefVector>("TightElectronRef");
}
...
// member functions
//
float ElectronFilterTight::dEtaInSeed (reco::GsfElectronCollection::const_iterator ele){
...
float ElectronFilterTight::GsfEleEInverseMinusPInverse (reco::GsfElectronCollection::const_iterator ele)
{
...
int ElectronFilterTight::GsfEleMissingHitsCut(reco::GsfElectronCollection::const_iterator ele)
{
...
double ElectronFilterTight::GsfEleEffAreaPFIsoCut(reco::GsfElectronCollection::const_iterator ele,edm::Event& iEvent)
{
...
bool ElectronFilterTight::GsfEleConversionVetoCut(reco::GsfElectronCollection::const_iterator ele ,edm::Event& iEvent)
{
