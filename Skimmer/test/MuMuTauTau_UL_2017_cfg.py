...
# with command line options: step6 --filein file:ggh01_M125_Toa01a01_M10_Tomumutautau_slc7_amd64_gcc700_CMSSW_10_6_19_tarball_35247313_10_recoAOD.root --fileout file:MiniAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 106X_mc2017_realistic_v6 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename MuMuTauTau_UL_2017_cfg.py -n 200 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step6 nevts:200'),
...
GT = {'mcgt': '106X_mc2017_realistic_v6', 'datagt': '106X_dataRun2_v32',} #UL_2017
...
dump_file = open('dump_config_UL_2017.py','w')
