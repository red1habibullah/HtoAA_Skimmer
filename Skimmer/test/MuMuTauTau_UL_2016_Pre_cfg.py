...
# with command line options: step6 --filein file:/afs/cern.ch/work/r/rhabibul/UL-Samples/2016-Pre/ggh01_M125_Toa01a01_M10_Tomumutautau_slc7_amd64_gcc700_CMSSW_10_6_19_tarball_14120207_10_recoAOD.root --fileout file:mumutautau_UL_2016_Pre.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v9 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2016_HIPM --python_filename MuMuTauTau_UL_2016_Pre_cfg.py -n 10 --no_exec
import FWCore.ParameterSet.Config as cms


from FWCore.ParameterSet.VarParsing import VarParsing
options = VarParsing('analysis')
options.outputFile = 'mumutautau_UL_2016_Pre.root'
options.inputFiles = 'file:/afs/cern.ch/work/r/rhabibul/UL-Samples/2016-Pre/ggh01_M125_Toa01a01_M10_Tomumutautau_slc7_amd64_gcc700_CMSSW_10_6_19_tarball_14120207_10_recoAOD.root' 
...
GT = {'mcgt': '106X_mcRun2_asymptotic_preVFP_v9', 'datagt': '106X_dataRun2_v32',} #UL_2016-Pre
...
dump_file = open('dump_config_UL_2016_Pre.py','w')
