  ...
  trk_(consumes<reco::GsfTrackCollection>(iConfig.getParameter<edm::InputTag>("Tracks")))
{
  ...
  produces<reco::GsfElectronRefVector>("MediumElectronRef");
}
...
// member functions
//
float ElectronFilterMedium::dEtaInSeed (reco::GsfElectronCollection::const_iterator ele){
...
float ElectronFilterMedium::GsfEleEInverseMinusPInverse (reco::GsfElectronCollection::const_iterator ele)
{
...
int ElectronFilterMedium::GsfEleMissingHitsCut(reco::GsfElectronCollection::const_iterator ele)
{
...
double ElectronFilterMedium::GsfEleEffAreaPFIsoCut(reco::GsfElectronCollection::const_iterator ele,edm::Event& iEvent)
{
...
bool ElectronFilterMedium::GsfEleConversionVetoCut(reco::GsfElectronCollection::const_iterator ele ,edm::Event& iEvent)
{
