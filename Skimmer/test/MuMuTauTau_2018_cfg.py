...
options.inputFiles ='file:/eos/uscms/store/mc/RunIIAutumn18DRPremix/WWZJetsTo4L2Nu_4f_TuneCP5_13TeV_amcatnloFXFX_pythia8/AODSIM/102X_upgrade2018_realistic_v15-v1/10000/0431F578-BAB4-F14A-BA34-F7BB4AC3372C.root'
#'/store/mc/RunIIAutumn18DRPremix/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/AODSIM/102X_upgrade2018_realistic_v15-v1/100000/F1425090-2860-B647-8E5B-72E3A17EA48F.root'
...
GT = {'mcgt': '102X_upgrade2018_realistic_v20', 'datagt': '102X_dataRun2_v12',} #2018 A-C #102x_upgrade2018_realistic_v20 not working?
...
#Finally Adding the skim part
from HtoAA_Skimmer.Skimmer.customizeSkimsNew import addMuMuTauTau
addMuMuTauTau(process,options)

#python dump for debug purposes
dump_file = open('dump_config_Debug.py','w')
