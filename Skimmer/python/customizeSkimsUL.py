...
def addMuMuTauTau(process,options,**kwargs):
    ...
    process.slimmedTausMuonCleanedMedium = process.slimmedTausNoDeepIDs.clone(src = cms.InputTag('selectedPatTausMuonCleanedMedium'))
    ...
    process.slimmedTausMuonCleanedTight = process.slimmedTausNoDeepIDs.clone(src = cms.InputTag('selectedPatTausMuonCleanedTight'))
   ...
   # patAlgosToolsTask.add(process.AssociationMapElectron)
    ...
    process.slimmedTausElectronCleanedMedium = process.slimmedTausNoDeepIDs.clone(src = cms.InputTag('selectedPatTausElectronCleanedMedium'))
    ...
    process.slimmedTausElectronCleanedTight = process.slimmedTausNoDeepIDs.clone(src = cms.InputTag('selectedPatTausElectronCleanedTight'))
